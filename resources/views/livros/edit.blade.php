    ...
    <x-slot name="header">
        <div>
            ...
            <p class="text-sm text-gray-500">
                Atualização dos dados do livro selecionado.
            </p>
        </div>
    </x-slot>
                    ...
                    <form method="POST" action="{{ route('livros.update', $livro) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input
                                ...
                                min="0"
                                class="mt-1 block w-full"
                                :value="old('quantidade_total', $livro->quantidade_total)"
                                required
                            />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input
                                ...
                                min="0"
                                class="mt-1 block w-full"
                                :value="old('quantidade_disponivel', $livro->quantidade_disponivel)"
                                required
                            />
